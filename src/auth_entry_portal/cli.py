...
from auth_entry_portal.services.bootstrap_service import BootstrapError, bootstrap_admin, mark_installation_initialized
from auth_entry_portal.services.cli_user_auth import authenticate_cli_actor
from auth_entry_portal.services.cli_user_output import exit_code, render_records, render_result
...
def main(argv: list[str] | None = None) -> int:
    ...
    uvicorn.run("auth_entry_portal.main:app", host=args.host, port=args.port); return 0
