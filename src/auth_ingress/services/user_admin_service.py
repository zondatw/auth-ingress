...
from auth_ingress.models import AuditEvent, Group, GroupMembership, PasswordResetRequest, PortalSession, User
...
from auth_ingress.services.session_service import revoke_user_sessions
