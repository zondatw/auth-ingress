...
from auth_portal.security.cookies import cookie_options, decode_session_id, encode_session_id
...
from auth_portal.services.authentication_service import authenticate, normalize_email
from auth_portal.services.session_service import create_session, revoke_session, validate_session
