...
from auth_ingress.services.downstream_service import DownstreamUnavailable, fetch_downstream
from auth_ingress.services.proxy_authorization_service import issue_launch_ticket
